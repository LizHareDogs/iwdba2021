...
Person 1 affiliations

.large[Person 2] 

Person 2 affiliations

.large[Person 3]

Person 3 affiliations
...
.pull-left[
``` {r, VaukBobHammock, fig.cap="A laughing man is lying on his back in a hammock next to a squiggly black lab, paws in the air, head so far back only the underside of the jaw is visible."}
