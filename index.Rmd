...
- Career choice based on
  - Formal assessment
  - Trainer observation
- Career flaxibility contributes to very high success rate: 93%]
...
tabCscoreK <- kableExtra::kbl(tabCscore, caption="Behaviors Rated on Frequency and Intensity")
...
tabBscoreK <- kableExtra::kbl(tabBscore, caption="Behaviors Rated on Intensity")
